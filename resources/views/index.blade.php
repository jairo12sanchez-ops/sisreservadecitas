    ...
    <div class="branding d-flex align-items-center">
        ...
        <div class="container position-relative d-flex align-items-center justify-content-between">
            <a href="{{url('/')}}" class="logo d-flex align-items-center me-auto">
                <!-- Logo de la clínica -->
                <img src="{{ $configuracion ? $configuracion->logo_url : asset('assets/img/logo empresa odoes.jpeg') }}" alt="JasaDent Logo" style="max-height: 100px; padding: 10px; background-color: white; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.2);">
            </a>
