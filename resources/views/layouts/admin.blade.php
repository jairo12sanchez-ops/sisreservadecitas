...
<head>
    ...
    <link href="{{ asset('assets/img/logo_jasadent.jpeg') }}?v={{ time() }}" rel="icon">
    <link href="{{ asset('assets/img/logo_jasadent.jpeg') }}?v={{ time() }}" rel="apple-touch-icon">
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{url('/admin')}}" class="nav-link">Sistema de reservas de citas odontologicas</a>
            </li>
        </ul>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="" class="brand-link">
            <img src="{{ asset('assets/img/logo_jasadent.jpeg') }}?v={{ time() }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex flex-column align-items-center">
                <div class="image mb-2">
                    <img src="{{ ($configuracion ? $configuracion->logo_url : asset('assets/img/logo_empresa_odoes.jpeg')) }}?v={{ time() }}" 
                         class="img-fluid elevation-2" 
                         alt="Logo Empresa" 
                         style="width: 160px !important; border-radius: 8px; background: white; padding: 2px;">
                </div>
...
with font-awesome or any other icon font library -->
                    ...
                    @endcan
                    <li class="nav-item">
                        <a href="{{ route('logout') }}" class="nav-link" style="background-color: darkred" id=""
                           onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"
                        >
                            <i class="nav-icon fas bi bi-lock"></i>
                            <p>
                                Cerrar Sesion
