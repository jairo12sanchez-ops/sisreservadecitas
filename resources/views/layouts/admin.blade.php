...
<head>
    ...
    <link href="{{ asset('assets/img/logo_jasadent.jpeg') }}" rel="icon">
    <link href="{{ asset('assets/img/logo_jasadent.jpeg') }}" rel="apple-touch-icon">
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="" class="brand-link">
            <img src="{{ url('assets/img/logo_jasadent.jpeg') . '?v=' . time() }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
