    ...
    <div class="card card-outline card-primary">
        <div class="card-header text-center">
            <a href="" class="d-flex justify-content-center align-items-center">
                <img src="{{asset('assets/img/logo_jasadent.jpeg')}}" alt="JasaDent Logo" style="max-height: 100px; padding: 10px; background-color: white; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.2);">
            </a>
        </div>
        <div class="card-body">
