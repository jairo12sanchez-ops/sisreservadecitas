                ...
                <div class="card-body">
                    <table id="example1" class="table table-striped table-bordered table-hover table-sm">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center"><b>Consultorio</b></th>
                            <th style="text-align: center"><b>Ubicacion</b></th>
                            <th style="text-align: center"><b>Capacidad</b></th>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <a href="{{url('admin/consultorios/'.$consultorio->id.'/confirmDelete')}}" type="button" class="btn btn-danger btn-sm"><i class="bi bi-trash"></i></a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
