            ...
            @can('admin.horarios.index')
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-info">
                        ...
                        <a href="" class="small-box-footer">Mas Información <i class="fas bi bi-calendar2-check"></i></a>
                    </div>
                </div>
            @endcan
            ...
            <div class="col-md-12">
                <div class="card card-outline card-warning">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-4">
                                <h3 class="card-title">Calendario De Reservas de Citas Odontologicas</h3>
                            </div>
                            <div class="col-md-4">
                                <div style="text-align: right">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <hr>
                            <a href="{{url('/admin/ver_reservas',Auth::user()->id)}}" class="btn btn-success"><i class="bi bi-calendar2-check"></i></i> Ver Reservas</a>
