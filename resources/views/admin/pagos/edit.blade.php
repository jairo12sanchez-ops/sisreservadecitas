    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-success">
                ...
                <div class="card-body">
                    <form action="{{ url('/admin/pagos',$pago->id) }}" method="POST" id="form_pago">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="monto" id="monto" value="{{$pago->monto}}"     class="form-control" placeholder="0" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
